...
1. Go to your Github profile. The url should be [http://github.com/your-user-name]().
...
~~~
[your-github-name]/[repo-name]
forked from Reproducible-Science-Curriculum/[repo-name]
~~~
...
You can get more details about modifications with a ![git-unt](img/rstudio-git-diff.png):
...
- When you cloned your repo into an RStudio project you got two bonus files that weren't there before: `.gitignore` and `.[repo-name].Rproj`
...
- `.[repo-name].Rproj`: This file maintains metadata on the R project.
